...
std::vector<std::string> Decoder::parse(std::string &text)
{
...
void Decoder::remove_other(std::stack<std::pair<std::string, int>> &priority_stack, std::vector<std::string> &result, int priority)
{
...
std::vector<std::string> Decoder::postfix(std::vector<std::string> &parsed_elements)
{
...
std::vector<std::string> Decoder::simplify_postfix(std::vector<std::string> &postfix)
{
